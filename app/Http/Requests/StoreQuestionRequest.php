...
class StoreQuestionRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'answer_c' => 'required|max:1000',
            'answer_d' => 'required|max:1000',
            'explain' => 'max:3000',
    ...
    public function messages()
    {
        return [
            ...
            'answer_c.required' => '<i class="bi bi-exclamation-circle"></i> Chưa nhập đáp án',
            'answer_c.max' => '<i class="bi bi-exclamation-circle"></i> Vui lòng nhập không quá 1000 ký tự',
            'answer_d.required' => '<i class="bi bi-exclamation-circle"></i> Chưa nhập đáp án',
