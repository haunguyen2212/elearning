      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="" id="frm-edit-profile" method="post" class="row g-3 px-2">
                ...
                <div class="col-12 col-md-6">
                    <label for="place_of_birth_edit" class="form-label">Nơi sinh (*)</label>
                    <input type="text" class="form-control" id="place_of_birth_edit" name="place_of_birth">
                    <span class="text-danger txt_error txt_place_of_birth mt-1"></span>
                </div>
